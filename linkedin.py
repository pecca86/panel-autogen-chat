    ...
    def get_linked_in_chat(self):
        ...
        def add_openai_key_to_env(key): 
            ...
            if not key.startswith("sk-"):
                chat_interface.send("Please enter YOUR OWN ASSHOLE!!", **SYSTEM_KWARGS)
                return
        ...
        if os.environ.get("OPENAI_API_KEY") is None:
            chat_interface.send("Please enter you OpenAI key to begin the chat WITH YOUR ANUS!", user="System", respond=False)
